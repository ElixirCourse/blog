...
Като пишем макроси в Еликсир не генерираме само код, ние го инжектираме в контекста подаден ни от извикващия човек. Контекстът държи локалния `binding`, вмъкнатите модули и псевдоними за човека. Един вид контекстът е света, който виждаме от макроса - за това е толкова важен.
