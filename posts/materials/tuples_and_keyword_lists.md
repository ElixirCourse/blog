...
Освен в някой *Erlang*-ски функции разбира се.

Такива списъци се използват за функции с опционални, именовани параметри, както и когато искаме да имаме асоциативен списък в който да е възможно да имаме няколко еднакви ключа.
...
По този начин си дефинираме две функции `Math.sum/2` и `Math.sum/3`. Или просто една, `Math.sum/2` с опционални именовани параметри.
...
Само ако подадените ни опции са по-множество на `@sum_supported_options` ще ги прочетем.
...
Забележете и как такива *tuple* се ползвам в *match* изрази в условията на `with` израза.
