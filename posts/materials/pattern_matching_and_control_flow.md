 ...
 * Всичко е *immutable*.
 * *Pattern matching* - данни могат да се конструират и деконструират в зависимост от тяхна структура. Различни варианти на една функция могат да се дефинират в зависимост от данните, които приема.

Има и други подобни симптоми, но тези са достатъчни засега.
Нека да разгледаме *pattern matching*-а, който Elixir ни предоставя.
...
Важно следствие от начина по който работи *mattern matching*-а, е че той може да се използва за проверка на очаквани стойности.
Пример:
...
Имената им задължително започват с малка латинска буква или подчертавка (`_`), следвана от букви, цифри или подчертавки.
