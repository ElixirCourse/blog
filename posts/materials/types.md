...
Речниците подобно на *tuple*-ите се сравняват първо по големина (брой на ключовете), а после по самите ключове, като тук ключове цели числа се смятата за по-малки от ключове от тип числа с плаваща запетая.
...
искаме да вдигнем всеки от тях на квадрат. Как става това? Ами строим нов списък с квадратите,
